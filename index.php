...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="row">
                    <img src="img/content/office6.jpg" class="img-fluid rounded"/>
                </div>
                <div class="row">
                    <img src="img/content/office7.jpg" class="img-fluid rounded"/>
                </div>
                <div class="row">
                    <img src="img/content/office18.jpg" class="img-fluid rounded"/>
                </div>
            </div>
            <div class="col-md-3">
